    ...
    return (
        <section className="about-container">
            <div className="myinfo-profile-container">
                ...
                <div className="myinfo-text-container">
                    ...
                    <div className="profile-info-mobile-container">
                        ...
                        <div className="profile-mobile-title">Mobile</div>
                        <div className="profile-mobile-text">010-6301-7841</div>
                    </div>
            ...
            <div className="myinfo-description-container">
