...
function Skills() {
    return (
        <section className="skills-container">
            ...
            <div className="skills-type-container">
                ...
                <div className="skills-box-container">
                    <div className="skills-stack-container">
                        ...
                        <div className="stack-text">Javascript</div>
                    </div>
                    <div className="skills-stack-container">
                        <img className="stack-image" src={css} alt="" />
                        <div className="stack-text">CSS</div>
                    </div>
                    <div className="skills-stack-container">
                        <img className="stack-image" src={html} alt="" />
                        <div className="stack-text">HTML</div>
                    </div>
                </div>
            </div>
            <div className="skills-type-container">
                ...
                <div className="skills-box-container">
                    <div className="skills-stack-container">
                        ...
                        <div className="stack-text">Node.js</div>
                    </div>
                    <div className="skills-stack-container">
                        <img className="stack-image" src={express} alt="" />
                        <div className="stack-text">Express</div>
                    </div>
                    <div className="skills-stack-container">
                        <img className="stack-image" src={react} alt="" />
                        <div className="stack-text">React</div>
                    </div>
                    <div className="skills-stack-container">
                        <img className="stack-image" src={sass} alt="" />
                        <div className="stack-text">Sass(SCSS)</div>
                    </div>
                    <div className="skills-stack-container">
                        <img className="stack-image" src={styledcomponent} alt="" />
                        <div className="stack-text">styled-component</div>
                    </div>
                </div>
            </div>
            <div className="skills-type-container">
                ...
                <div className="skills-box-container">
                    <div className="skills-stack-container">
                        ...
                        <div className="stack-text">MySQL</div>
                    </div>
                    <div className="skills-stack-container">
                        <img className="stack-image" src={aws} alt="" />
                        <div className="stack-text">AWS</div>
                    </div>
                </div>
            </div>
            <div className="skills-type-container">
                ...
                <div className="skills-box-container">
                    <div className="skills-stack-container">
                        ...
                        <div className="stack-text">Git</div>
                    </div>
                    <div className="skills-stack-container">
                        <img className="stack-image" src={notion} alt="" />
                        <div className="stack-text">Notion</div>
                    </div>
                    <div className="skills-stack-container">
                        <img className="stack-image" src={github} alt="" />
                        <div className="stack-text">Github</div>
                    </div>
                </div>
            </div>
            <div className="skills-type-container">
